...
SECRET_KEY = 'django-insecure-gwr=3=kssvc^#529o(!$b72+$($g)79_0dzp3ttcx2i#q+d3+*'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://fec-roadmap.precis.tu-darmstadt.de",
]
...
if DB_ENGINE == 'postgresql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'career_roadmap'),
            'USER': os.getenv('DB_USER', 'career_roadmap_user'),
